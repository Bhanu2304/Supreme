...
class LoginController extends Controller
{
    ...
    */
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        {
            #$page_access[0]->access = "201,202,256,257,180,149";
            #$page_access[0]->parent_access = "200,130,131";
        ...
        //User Rights 
        #echo "SELECT access,parent_access FROM `manage_access` WHERE UserId='$UserId' limit 1";die;
        $page_arr =  "";
...
//        }
        ...
        {
            $html .='<li><a href="'.$page[$parent_id]->page_url.'"><i class="';
        ...
        else
        {
            ...
            $html.='<i class="metismenu-state-icon fa fa-angle-right"></i></a><ul>';
