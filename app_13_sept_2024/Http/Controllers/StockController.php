    ...
    */
    ...
    public function fresh_defective_stock(Request $request)
    {
        ...
        if(empty($whereTag))
        {
            ...
            $req_arr           =   DB::select("SELECT tdp.*,brand_name,category_name,product_name,model_name,ticket_no,job_no,tdp.part_po_date,tsc.center_name,tsc.asc_code,tdp.part_po_no FROM tagging_damage_part tdp
