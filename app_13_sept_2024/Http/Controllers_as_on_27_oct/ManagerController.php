...
inner JOIN `region_master` regm ON ar_map.region_id=regm.region_id $region_str";
    ...
    public function map_region(Request $request)
    {
        ...
        $regional_man  = RegionalManagerMaster::whereRaw("user_type!='NSM' and man_status='1' ")->orderByRaw('man_name ASC')->get();
        ...
        else if($user_type=='ASM')
        {
            ...
            else 
            {
                $area_master = new RegAreaMaster();
                    ...
                    //get user type
                    $RegionalManagerMaster = RegionalManagerMaster::selectRaw("reg_man_id='$reg_man_id'")->first();
                    $area_master->user_type = $RegionalManagerMaster->user_type;
    ...
    public function get_map_area(Request $request)
    {
        ...
        if(!empty($region_id))
        {
            ...
            $qry .= " and regm.region= '$region_id'";
            $qry1 .= " and regm.region= '$region_id'";
        }
