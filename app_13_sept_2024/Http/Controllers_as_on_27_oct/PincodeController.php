...
//                PinVendorList::insert($inserArr);
    ...
    public function get_pincode_by_state_name(Request $request)
    {
        ...
        $pin_master = DB::select("SELECT pincode from pincode_master where state_id='$state_id'");
   ...
   public function get_pincode_by_dist_id(Request $request)
    {
        ...
        $pin_master = DB::select("SELECT Pin_Id,pincode from pincode_master where dist_id='$dist_id'");
