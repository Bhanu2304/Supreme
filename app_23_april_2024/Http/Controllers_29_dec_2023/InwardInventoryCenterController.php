...
class InwardInventoryCenterController extends Controller
{
    ...
    {
        Session::put("page-title","Center Inward Stock");
        ...
        $req_arr           =   DB::select("SELECT * FROM `inward_inventory_center` inw ");        
    ...
    ?>
                                                    <tr id="row<?php echo $a; ?>">
                                                     ...
                                                     <td><select  required="" id="brand<?php echo $a;?>" name="sparepart[<?php echo $a;?>][brand]"  onchange="get_model('<?php echo $a;?>',this.value)">
                                             ...
                                             <td><select  required="" id="model<?php echo $a;?>" name="sparepart[<?php echo $a;?>][model]"  onchange="get_partcode('<?php echo $a;?>',this.value)">
                                                             <option value="">Select</option>
                                             ...
                                             <td><select  required="" id="part_code<?php echo $a;?>" name="sparepart[<?php echo $a;?>][part_code]"  onchange="get_part_name('<?php echo $a;?>',this.value)">
                                                             <option value="">Select</option>
