...
order BY field_name,sub_field_name";
    ...
    {       
            $file_arr = array('wrrn'=>'Warranty card','prcs'=>'Purchase Invoice','mdl'=>'model_no_copy','srl'=>'Serial No. Image','smtm1'=>'Symptom Image 1','smtm2'=>'Any special Approval','smtm3'=>'symptom_photo3');
