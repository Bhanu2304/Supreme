...
WHERE 1=1 "; 
 ...
 // Closure Code Details
    ...
    public function save_closure_code_observation(Request $request)
    {
     ...
     $Tag = DB::update("update tagging_master set closure_codes='$closure_codes',case_close='1' where TagId ='$TagId'");
...
WHERE 1=1 "; 
    ...
    public function complaint_save_observation(Request $request)
    {
        ...
        #print_r($taggingArr);exit;
        // echo "update tagging_master set ccsc='$ccsc', job_card='$job_card', videos='$videos', crf='$crf', ftir='$ftir',
        ...
        // final_job_status='$final_job_status' where TagId ='$RTagId'";die;
