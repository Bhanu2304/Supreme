...
Route::post('get-part-name', 'InventoryController@get_part_name_by_model')->name('get-part-name');
Route::post('get-part-no', 'InventoryController@get_partno_by_part_name')->name('get-part-no');
