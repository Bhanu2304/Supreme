            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Defective Return REPORT</h5>
                            <form method="post" action="export-defective-return-report">
...
{ 
    ...
    function get_view()
    {
       ...
       ajax('export-defective-return-report',uqry,'disp_records');
