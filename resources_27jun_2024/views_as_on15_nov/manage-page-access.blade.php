                    ...
                    <div class="main-card mb-3 card">
                        ...
                        ?>
                           ...
                           <table class="table" border="1">
                               <thead>
                               <tr>
                                   <th rowspan="3">Page</th>
                                   <th colspan="<?php echo $cnt; ?>">User Type</th>
                               </tr>  
                               <tr>
                            <?php
                                    
                                    
                                    //print_r($userTypeMaster); exit;
                                    foreach($type as $tp)
                                    {
                                            $count = count($userTypeMaster[$tp]);
                                            echo '<th colspan="'.$count.'">'.$tp.'</th>';      
                                    }
                            ?>
                                </tr>
                               <tr>
                            <?php
                                    foreach($type as $tp)
                                    {
                                        foreach($userTypeMaster[$tp] as $userType=>$user)
                                        {
                                            echo '<th>'.$user.'</th>';
                                        }
                                    }
