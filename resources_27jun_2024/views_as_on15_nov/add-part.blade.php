                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="customer_price" id="customer_price" placeholder="Customer Price" type="number" onkeypress="return checkNumber(this.value,event);" class="form-control" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
