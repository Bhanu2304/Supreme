            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Edit Manager</h5>
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <select id="center_id" name="center_id" class="form-control">
                                                ...
                                                <option value="{{$region->center_id}}" <?php if($region->center_id==$data_state_record['center_id']) { echo 'selected'; }  ?>>{{$region->center_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
