                        ...
                        <?php   $srno = 1;
                                foreach($req_arr as $req)
                                {
                                    echo '<tr>';
                                        ...
                                        {
                                            echo '<td>
                                            <a href="view-inw-inv-entry?inw_id='.base64_encode($req->inward_id).'">View</a> ||
                                            <a href="po-inward-inv-cancel?inw_id='.base64_encode($req->inward_id).'">Cancel</a></td>';
                                        }
                                        else
                                        {
                                            echo '<td><a href="po-inward-inv-entry?req_id='.base64_encode($req->req_id).'">Inward</a></td>';
                                        }
                        ...
                        <?php   $srno = 1;
                                foreach($req_arr3 as $req)
                                {
                                    echo '<tr>';
                                        ...
                                        //echo '<td><a href="edit-inw-inv-entry?inw_id='.base64_encode($req->inw_id).'">Edit</a></td>';
                                        echo '<td><a href="mrf-pdf?inw_id='.base64_encode($req->inw_id).'">Pdf</a></td>';
