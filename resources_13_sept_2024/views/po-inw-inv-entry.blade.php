...
function updateItemList(value, inputId) 
{
    
    var index = inputId.replace('item_qty', '');

    console.log('item_list_' + index);
    var itemListContainer = document.getElementById('item_list_' + index);

    itemListContainer.innerHTML = '';

    // Create new item list based on the input quantity
    for (var i = 0; i < value; i++) {
        var inputField = document.createElement('input');
        inputField.type = 'text';
        inputField.name = 'Itemlist' + index + '[' + i + ']';
        inputField.placeholder = 'Sr No.';
        itemListContainer.appendChild(inputField);
        itemListContainer.appendChild(document.createElement('br'));
    }
}
                                        ...
                                        <thead>
                                            ...
                                            foreach($po_inv_parts as $po_inv_part) { ?> 
                                             <tr>
                                                 ...
                                                 <td><select autocomplete="off" id="model<?php echo $a;?>" name="part[model<?php echo $a;?>]"  readonly>
                                                                 <option value="">Select</option>
                                                                 <?php
                                                                        foreach($po_inv_part->mod_list as $mod)
                                                                        {
                                                 ...
                                                 <td><select autocomplete="off" id="part_code<?php echo $a;?>"  name="part[part_code<?php echo $a;?>]" readonly>
                                                                 <option value="">Select</option> 
                                                                 <?php
                                                                        foreach($po_inv_part->part_list as $mod)
                                                                        {
                                                 ...
                                                 <td><input autocomplete="off" type="text" name="part[hsn_code<?php echo $a;?>]" id="hsn_code<?php echo $a;?>"  placeholder="HSN" ></td>
                                                 <td><input autocomplete="off" type="text" name="part[item_qty<?php echo $a;?>]" onkeypress="return checkNumber_new(this.value,event)" id="item_qty<?php echo $a;?>" value="<?php echo $po_inv_part->req_qty; ?>"  placeholder="Qty." ></td>
                                                 ...
                                                 <td><input autocomplete="off" type="text" name="part[purchase_amt<?php echo $a;?>]" onkeypress="return checkNumber(this.value,event)" id="purchase_amt<?php echo $a;?>" value="<?php echo $po_inv_part->curr_amt; ?>" placeholder="Amount" readonly></td>
