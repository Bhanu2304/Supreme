                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="position-relative form-group">
                                                                ...
                                                                <a href="{{route('vendor-tag-view')}}" class="mt-2 btn btn-danger btn-grad" style="float:right;" data-original-title="" title="">Exit</a>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Service Type <span style="color: #f00;">*</span></label>
                                                        <select id="service_type" name="service_type" class="form-control"  required="">
                                                            ...
                                                            <option value="Demo & Installation" <?php //if($data['service_type']=='Demo & Installation') { echo "selected";} ?>>Demo & Installation</option>
                                                            ...
                                                            <option value="Demo & Installation" <?php if($data['service_type']=='Demo & Installation') { echo "selected";} ?> >Demo & Installation</option>
                                                            <option value="Online" <?php if($data['service_type']=='Online') { echo "selected";} ?>>Online</option>
                                                            <option value="Refurbished" <?php if($data['service_type']=='Refurbished') { echo "selected";} ?>>Refurbished</option>
                                                            <option value="Site Visit" <?php if($data['service_type']=='Site Visit') { echo "selected";} ?>>Site Visit</option>
                                                            <option value="Walk in" <?php if($data['service_type']=='Walk in') { echo "selected";} ?>>Walk in</option>
						...
						<div class="col-md-4">
						    ...
						    <input name="report_fault" id="report_fault" placeholder="Special Comments" type="text" value="<?php echo $data['report_fault']; ?>" class="form-control" ></div>
                                        ...
                                        <div id="Part_Required" class="tabFormcontent">
                                            ...
                                            <div id="part_arr">
                                            <?php  foreach($TagPart as $tag) {  $part_name_arr = $tag->part_name_arr; ?>    
                                                <div class="form-row">
                                                        <div class="col-md-3">
                                                            <div class="position-relative form-group"><label for="examplePassword11" class=""> Part Code</label>
                                                                <select id="part_name1" name="SparePart[part_name][]"  class="form-control" onchange="get_partno('1',this.value)" >
                                                                    <?php
                                                                            ...
                                                                            {
                                                                                ?>       <option value="<?php echo $part->part_no; ?>" <?php if($tag->part_no==$part->part_no) { echo 'selected';} ?>><?php echo $part->part_no; ?></option>     
                                                                    <?php   }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="position-relative form-group"><label for="examplePassword11" class="">Part Name </label>
                                                                <select id="part_no1" name="SparePart[part_no][]" class="form-control" onchange="get_hsn_code('1',this.value)" >
                                                                    <?php
                                                                            foreach($part_name_arr as $part)
                                                                            {
                                                                                ?>       <option value="<?php echo $part->part_name; ?>" <?php if($tag->part_name==$part->part_name) { echo 'selected';} ?>><?php echo $part->part_name; ?></option>     
                                                                    <?php   }
                                                                    ?>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo "$back?".base64_decode($whereTag); ?>" class="mt-2 btn btn-primary">Back</a>
                                                       <a href="{{route('vendor-tag-view')}}" class="btn btn-danger btn-grad" style="float:right;" data-original-title="" title="">Exit</a>
                                                    </div>
                                                </div>
