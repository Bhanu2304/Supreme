            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        ...
                        <form method="get" action="{{route('part-tag-view')}}" class="form-horizontal"  >
 				...
 				<div class="col-md-8">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" action="part-approve"  >
                                
<!--                                <div class="form-row">
                                    <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        <label for="examplePassword11" class="">Approval</label>
                                        <select id="rma_approve" name="rma_approve" class="form-control" required=""> 
                              ...
                              <tbody>
                                 ...
                                 <?php $srno = 1;
                                        foreach($DataArr as $record)
                                        {
                                            ...
                                            echo $srno++.'</td>';
                                                echo '<td><a href="part-tag-case-view?TagId='.$record->TagId."&whereTag=$whereTag".'">'.$record->call_status.'</a></td>';
                                                ...
                                                //echo '<td>'.$record->Residence_No.'</td>';
                                                //echo '<td>'.$record->Serial_No.'</td>';
                                                echo '<td>'.$record->Product.'</td>';
                                                //echo '<td>'.$record->Model.'</td>';
                                                //echo '<td>'.$record->Bill_Purchase_Date.'</td>';
                                                //echo '<td>'.$record->Date_of_Installation.'</td>';
                                                //echo '<td>'.$record->Warrenty_End_Date.'</td>';
                                                //echo '<td>'.$record->warranty_status.'</td>';
                                                //echo '<td>'.$record->observation.'</td>';;
                                            echo '</tr>';
                                        }
                                 ?>
