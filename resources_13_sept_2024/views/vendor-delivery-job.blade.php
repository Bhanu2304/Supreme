            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">View Delivery Job</h5>
                            ...
                            <p id="scc">@if(Session::has('message'))<h5><font color="green"> {{ Session::get('message') }}</font></h5> @endif </p>
                                 ...
                                 <form method="get" action="{{route('vendor-view-complete-job')}}" autocomplete="off" class="form-horizontal"  >
 				...
 				<div class="col-md-2">
                            ...
                            <h5 class="card-title">Complete Job Details</h5>
                                     ...
                                     echo '<th colspan="10" class="text-center">No record found!</th>';
                                        ...
                                        foreach($DataArr as $record)
                                        {
                                            ...
                                            echo $srno++.'</td>';
                                                ...
                                                {
                                                    echo '<a href="vendor-observation-cl?TagId='.$record->TagId.'">'.$record->job_no.'</a>';
                                                }else{
                                                    echo '<a href="vendor-observation?TagId='.$record->TagId.'">'.$record->job_no.'</a>';
                                                }
                                               # echo '<a href="vendor-observation?whereTag='.$whereTag.'&TagId='.$record->TagId.'">'.$record->job_no.'</a>';
                                                ...
                                                echo '<td>'.$record->delivery_date.'</td>';
                                                echo '<td>'.$record->se_del_remarks.'</td>';
                                            echo '</tr>';
                                        }
                                 ?>
