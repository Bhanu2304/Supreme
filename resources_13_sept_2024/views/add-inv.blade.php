                                    ...
                                    <table id="table_id" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="Officer"><?php $consuption = $cnpt_arr[$Data->Part_Name][$Data->Part_No]; echo round($Data->stock_qty-$consuption); ?></td>
...
function get_product_category(div_id,brand_id)
{
    ...
    var result = (div_id === '_search') ? '<option value="">All</option>' : '';
