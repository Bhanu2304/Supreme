                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="closure_code" id="closure_code" placeholder="Enter Closure Code" value="<?php echo $data['closure_code']; ?>" type="text" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <label for="exampleAddress" class="">Amount</label>
                                            <input name="amount" id="amount" placeholder="Amount" type="text" class="form-control" value="<?php echo $data['amount']; ?>" onkeypress="return checkNumber(this.value,event)" maxlength="6">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <textarea name="description" id="description" cols="30" rows="10" class="form-control" placeholder="Enter Description" required><?php echo $data['description']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
