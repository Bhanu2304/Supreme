                            ...
                            <?php   $srno = 1; #print_r($po_part_master);
                                    foreach($po_part_master as $po_job)
                                    {
                                        echo '<tr id="tr'.$po_job->req_part_id.'">';
                                            ...
                                            echo '</td>';
                                            echo '<td>';?>
                                            <input type="text" onkeypress="return checkNumber(this.value,event)" autocomplete="off" id="issued_qty<?php echo $po_job->req_part_id; ?>" name="issued_qty<?php echo $po_job->req_part_id; ?>"  />
                                            <?php echo '</td>';
                                            echo '<td>';?>
                                            <input onkeypress="return checkNumber(this.value,event)" autocomplete="off" type="text" id="discount<?php echo $po_job->req_part_id; ?>" name="discount<?php echo $po_job->req_part_id; ?>"  />
                                            <?php echo '</td>';
                                            echo '<td>';?>
                                            ...
                                            if(!empty($po_job->bal_qty))
                                            {
                                            echo '<a href="#" onclick="approve('."'{$po_job->req_part_id}'".')">Approve</a>';
                                            }
                                            else
                                            {
