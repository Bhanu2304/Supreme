...
function get_pins(){
    ...
    $.post('get-sc-pincode',{country_id:country_id,center_id:center_id,state_id:state_id}, function(data){
...
function get_pincode(state_id){
    ...
    $.post('get-pincode-by-state',{state_id:state_id}, function(data){
        $('#pincode').html(data);
    }); 
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <select name="state_id" id="state_id" onchange="get_pincode(this.value)" class="form-control" required="">
                                                <option value="">Select</option>
