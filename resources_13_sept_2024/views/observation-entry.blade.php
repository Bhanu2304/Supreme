                                                ...
                                                <form method="post" name="estmt_approve_save" id="estmt_approve_save" action="estmt-approve-save"></form>
                                                    <table border="1" id="tbl_part" style="width: 100%;">
                                                        <thead id="thead">
                                                            ...
                                                            <?php $i = 2; $total_amount= 0 ;  foreach($tagg_part_npc as $tpart) { $total_amount += $tpart->total ;?>
                                                            ...
                                                            <?php } ?>
                                                                <?php $i = 1; foreach($labr_part_npc as $tpart) { $tpart->part_id = $tpart->tlp_id;$total_amount += $tpart->total ; ?>
                                                                <tr id="tr<?php echo $tpart->part_id; ?>">
                                                                    <td>{{$i++}}</td>
                                                                    <td>
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php if($approvaltype == "special_discount"){ ?>
                                                                    <input  type="text" name="special_discount" id="special_discount" placeholder='Special Discount' onkeypress="return checkNumber(this.value,event)"  value="<?php echo $data['special_discount'];?>" >
                                                                    <button onclick="saveSpecialDiscount()">Save</button>
 ...
 function deleteRecord(id)
 {
    ...
    function saveSpecialDiscount() {
        ...
        if(specialDiscount == '') {
            ...
            $.ajax({
                url: 'save-special-discount',
                type: 'POST',
                data: { TagId:TagId,special_discount: specialDiscount },
                success: function(response) {
                    alert('Discount Save Successfully')
                },
                error: function(xhr, status, error) {
