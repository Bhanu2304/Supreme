            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        ...
                        <form method="get" action="{{route('view-payment')}}" class="form-horizontal"  >
                                        ...
                                        foreach($DataArr as $record)
                                        {
                                            ...
                                            echo $srno++.'</td>';
                                                ...
                                                echo '<td>';
                                                    ...
                                                    echo '<a href="update-payment-symptom?TagId='.$record->TagId."&whereTag=$whereTag".'">View</a>';
                                                ...
                                                echo '</td>';
                                                 ...
                                                 echo '<td>';
                                                    ...
                                                    echo '<a style="float:left" href="generate-TXInvoice?TagId='.$record->TagId."&whereTag=$whereTag".'">Invoice</a>';
                                                    
                                                    echo '<a style="float:right" href="generate-pdf?TagId='.$record->TagId.'">PDF </a>';
                                                ...
                                                echo '<td>'.$record->payment_source.'</td>';
