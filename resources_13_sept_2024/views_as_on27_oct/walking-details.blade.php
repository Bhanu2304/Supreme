            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Customer Registration/Walking</h5>
                            
                                @if(Session::has('message'))<h5><font color="green"> {{ Session::get('message') }}</font></h5> @endif
                                 @if(Session::has('error'))<h5><font color="red"> {{ Session::get('error') }}</font></h5> @endif
                                  
                        <form method="get" action="{{route('walking-master')}}" class="form-horizontal"  >
...
<div class="card-body">
                       ...
                       <h5 class="card-title">Registered Product Details</h5>
                            ...
                            <div class="form-group text-right">
                             <a href="tagging-data?tag_type=complaint&entry_type=walking" class="btn btn-success btn-grad btnr1" data-original-title="" title="">Make Complaint/Installation</a>
			 <a href="tagging-data?tag_type=general_query" class="btn btn-success btn-grad btnr1" data-original-title="" title="">Genaral Query</a>
                              ...
                              <a href="/aiwa/public/home" class="btn btn-danger btn-grad btnr1" data-original-title="" title="">Exit</a>
                           </div>
                        </div>
