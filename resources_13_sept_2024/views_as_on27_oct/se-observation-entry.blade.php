                    ...
                    <div class="app-main__inner">
                         <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <form method="post" action="se-save-ob" enctype="multipart/form-data">
                                    <div class="card-body">
						    ...
						    <input name="Landmark" id="Landmark" value="<?php echo $data['Landmark']; ?>" placeholder="Landmark" type="text" class="form-control" ></div>	
                                                    ...
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="place" id="place" class="form-control" >
                                                            <option value="">Select</option>
                                                            <?php   foreach($place_master as $pin_id=>$place)
                                                                    {
						...
						<div class="col-md-4">
                                                ...
                                                <div class="position-relative form-group"><label for="examplePassword11" class="">Customer Complaint &amp; Special Comments</label>
                                                    <input name="ccsc" id="ccsc" value="<?php echo $data['ccsc']; ?>" placeholder="Comments..." type="text" class="form-control"></div>
                                                </div>        
                                                 <div class="col-md-4"> 
