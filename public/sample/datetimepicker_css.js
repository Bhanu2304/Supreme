...
var imageFilesPath = "https://paypik.in/hdfc/public/sample/images/";
...
function RenderCssCal(bNewCal)
{
	...
	for (j = 1; j <= Cal.GetMonDays(); j += 1)
	{
		...
		if (DateBlockFlag=='' && DisableBeforeToday === true && ((j <= (dtToday.getDate())) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Month < dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Year < dtToday.getFullYear())))
		{                    
			strCell = GenCell(j, false, DisableColor, false);//Present & Before today's date is not clickable
		}
                else if (DateBlockFlag=='Pre' && DisableBeforeToday === true && ((j < (dtToday.getDate())) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Month < dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Year < dtToday.getFullYear())))
		{
		...
		else if ((j === (dtToday.getDate()-1)) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()))
		{
...
function NewCssCal(pCtrl, pFormat, pScroller, pShowTime, pTimeMode, pShowSeconds,pDateBlockFlag)
{
	// get current date and time
        DateBlockFlag = pDateBlockFlag;
	dtToday = new Date();
