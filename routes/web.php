...
Route::post('get-cl-product-by-category-id', 'ProductController@get_cl_product_by_category_id')->name('get-cl-product-by-category-id');
...
Route::post('get-part-no-by-model', 'SparePartController@get_partno_by_model')->name('get-part-no-by-model');
//Route::get('edit-inv', 'InventoryController@edit_inv')->name('edit-inv');
//Route::post('update-inv', 'InventoryController@update_inv')->name('update-inv');
...
Route::get('po-inward-inv-entry', 'InwardInventoryController@po_index')->name('po-inward-inv-entry'); 
Route::get('po-inward-inv-cancel', 'InwardInventoryController@cancel_inw_inv')->name('po-inward-inv-cancel'); 
...
// Inventory Inward Center Starts From Here
Route::get('inward-inv-entry-sc', 'InwardInventoryCenterController@index')->name('inward-inv-entry-sc');
Route::get('po-inward-inv-entry-sc', 'InwardInventoryCenterController@po_index')->name('po-inward-inv-entry-sc'); 
Route::post('save-inward-entry-sc', 'InwardInventoryCenterController@save_req_inv')->name('save-inward-entry-sc');
Route::get('view-inw-inv-entry-sc', 'InwardInventoryCenterController@view')->name('view-inw-inv-entry-sc');

Route::get('po-inward-inv-cancel-sc', 'InwardInventoryCenterController@cancel_inw_inv')->name('po-inward-inv-cancel-sc'); 

// Inventory Outward Center Starts From Here
Route::get('outward-view-po-sc', 'OutwardInventoryCenterController@index')->name('outward-view-po-sc');


//Center Dispatch PO Sc
Route::get('sc-dispatch-po', 'ScDispatchInventoryController@index')->name('sc-dispatch-po');
Route::post('save-dispatch-sc', 'ScDispatchInventoryController@save_dispatch')->name('save-dispatch-sc');
#Route::get('view-dispatch-sc', 'ScDispatchInventoryController@view_dispatch')->name('view-dispatch-sc');
Route::get('edit-dispatch-sc', 'ScDispatchInventoryController@edit_dispatch')->name('edit-dispatch-sc');
Route::get('update-dispatch-sc', 'ScDispatchInventoryController@update_dispatch')->name('update-dispatch-sc');
...
Route::get('outward-center-part-po', 'OutwardInventoryController@outward_center_part_po')->name('outward-center-part-po');
Route::post('approve-part-po-center', 'OutwardInventoryController@approve_part_po_center')->name('approve-part-po-center');

Route::post('approve-part-po-sc', 'OutwardInventoryCenterController@approve_part_po_sc')->name('approve-part-po-sc');
Route::post('cancel-part-po-sc', 'OutwardInventoryCenterController@cancel_part_po_sc')->name('cancel-part-po-sc');
//Route::post('save-inward-entry', 'InwardInventoryController@save_req_inv')->name('save-inward-entry');
//Route::get('view-inw-inv-entry', 'InwardInventoryController@view')->name('view-inw-inv-entry');
//Route::get('edit-inw-inv-entry', 'InwardInventoryController@edit')->name('edit-inw-inv-entry');
//Route::post('update-inward-entry', 'InwardInventoryController@update')->name('update-inward-entry');
...
Route::post('generate-challan', 'ApproveRequestInventoryController@generate_challan')->name('generate-challan');
...
Route::get('download-Challan','PdfController@downloadChallan');


Route::get('generate-Challan-sc','PdfController@generateChallansc');
Route::get('download-Challan-sc','PdfController@downloadChallansc');
...
#claim management
Route::match(['get', 'post'],'claim-complete-job', 'ClaimManagementController@index')->name('claim-complete-job');
Route::match(['get', 'post'],'retainership', 'ClaimManagementController@retainership')->name('retainership');
Route::post('get-asc-retainer', 'ClaimManagementController@get_asc_retainer')->name('get-asc-retainer');
Route::post('update-amount', 'ClaimManagementController@update_amount')->name('update-amount');
Route::match(['get', 'post'],'claim-settlement', 'ClaimManagementController@claim_settlement')->name('claim-settlement');


Route::post('get-job-claim', 'ClaimManagementController@get_job_claim')->name('get-job-claim');
Route::match(['get', 'post'],'claim-pending', 'ClaimManagementController@claim_pending')->name('claim-pending');
Route::match(['get', 'post'],'claim-approval', 'ClaimManagementController@claim_approval')->name('claim-approval');
Route::match(['get', 'post'],'claim-reject', 'ClaimManagementController@claim_reject')->name('claim-reject');
Route::match(['get', 'post'],'view-claim-pdf', 'PdfController@view_claim_pdf')->name('view-claim-pdf');
Route::match(['get', 'post'],'get-disperse-claim', 'ClaimManagementController@get_disperse_claim')->name('get-disperse-claim');
Route::match(['get', 'post'],'claim-disperse', 'ClaimManagementController@claim_disperse')->name('claim-disperse');
Route::post('disperse-export', 'ClaimManagementController@disperse_export')->name('disperse-export');
Route::post('get-asc-name',   'ClaimManagementController@get_asc_name')->name('get-asc-name');

#asc claim management

Route::match(['get', 'post'],'apply-jobs', 'ClaimManagementController@apply_jobs')->name('apply-jobs');
Route::match(['get', 'post'],'save-claim-jobs', 'ClaimManagementController@save_claim_jobs')->name('save-claim-jobs');
Route::match(['get', 'post'],'view-apply', 'ClaimManagementController@view_apply')->name('view-apply');
Route::match(['get', 'post'],'account-statement', 'ClaimManagementController@account_statement')->name('account-statement');


#special approval
Route::post('save-special-approval', 'VendorManagementController@save_special_approval')->name('save-special-approval');
Route::get('ho-transfer-job', 'VendorManagementController@ho_transfer_job')->name('ho-transfer-job');
Route::post('approved-special-job', 'VendorManagementController@approved_special_job')->name('approved-special-job');
Route::post('save-special-discount', 'VendorManagementController@save_special_discount')->name('save-special-discount');



# defective parts
Route::get('defective-pending-asc', 'DefectivePartsController@index')->name('defective-pending-asc');
Route::post('def-pending-accept', 'DefectivePartsController@def_pending_accept')->name('def-pending-accept');

Route::get('defective-part-dispatch', 'DefectivePartsController@defective_part_dispatch')->name('defective-part-dispatch');
Route::get('edit-defective-dispatch', 'DefectivePartsController@edit_defective_dispatch')->name('edit-defective-dispatch');
Route::post('save-defective-dispatch', 'DefectivePartsController@save_defective_dispatch')->name('save-defective-dispatch');
Route::get('defective-approval', 'DefectivePartsController@defective_approval')->name('defective-approval');
Route::post('def-approval-accept', 'DefectivePartsController@def_approval_accept')->name('def-approval-accept');


//cannibalized report
Route::get('cannibalized-report', 'ReportController@cannibalized_report')->name('cannibalized-report');
Route::post('export-cannibalized-report', 'ReportController@export_cannibalized_report')->name('export-cannibalized-report');

//Defective Returned Report 
Route::get('defective-return-report', 'ReportController@defective_return_report')->name('defective-return-report');
Route::post('export-defective-return-report', 'ReportController@export_defective_return')->name('export-defective-return-report');

//Defective Scraped Report 
Route::get('defective-scrap-report', 'ReportController@defective_scrap_report')->name('defective-scrap-report');
Route::post('export-defective-scrap-report', 'ReportController@export_defective_scrap')->name('export-defective-scrap-report');



// monthly stock report
Route::get('monthly-stock-report', 'ReportController@monthly_stock_report')->name('monthly-stock-report');
Route::post('export-monthly-stock', 'ReportController@export_monthly_stock')->name('export-monthly-stock');


// consumption report
Route::get('consumption-report', 'ReportController@consumption_report')->name('consumption-report');
Route::post('export-consumption-report', 'ReportController@export_consumption_report')->name('export-consumption-report');

//npc-fresh-stock-report
Route::get('npc-fresh-stock-report', 'ReportController@fresh_stock_report')->name('npc-fresh-stock-report');
Route::post('export-fresh-stock', 'ReportController@export_fresh_stock')->name('export-fresh-stock');

//asc-fresh-inventory-report
Route::get('asc-fresh-inventory-report', 'ReportController@fresh_inventory_report')->name('asc-fresh-inventory-report');
Route::post('export-fresh-inventory', 'ReportController@export_fresh_inventory')->name('export-fresh-inventory');

//asc-defective-report
Route::get('asc-defective-report', 'ReportController@asc_defective_report')->name('asc-defective-report');
Route::post('export-asc-defective', 'ReportController@export_asc_defective')->name('export-asc-defective');

//clarion-stock-report
Route::get('clarion-stock-report', 'ReportController@clarion_stock_report')->name('clarion-stock-report');
Route::post('export-clarion-stock', 'ReportController@export_clarion_stock')->name('export-clarion-stock');


# po and tax invoice

Route::get('po-invoice', 'PoInvoiceController@index')->name('po-invoice');
Route::get('po-invoice-pdf', 'PdfController@po_invoice_pdf')->name('po-invoice-pdf');

Route::get('po-invoice-pdf-new', 'PdfController@po_invoice_pdf_new')->name('po-invoice-pdf-new');

Route::get('po-invoice-pdf-sc-new', 'PdfController@po_invoice_pdf_sc_new')->name('po-invoice-pdf-sc-new');


Route::post('search-inventory', 'InventoryController@search_inventory')->name('search-inventory');
Route::post('search-center-inventory', 'InventoryCenterController@search_center_inventory')->name('search-center-inventory');
#Route::get('allocate-inv', 'InventoryCenterController@allocate_inv')->name('allocate-inv');
#Route::post('search-model', 'ProductController@search_model')->name('search-model');


Route::get('mrf-pdf', 'PdfController@mrf_pdf')->name('mrf-pdf');


// add supplier
Route::match(['get', 'post'], 'supplier', 'ManageController@supplier')->name('supplier');
Route::match(['get', 'post'],'edit-supplier', 'ManageController@edit_supplier')->name('edit-closure');


// issue part without po From Here
Route::get('issue-without-po', 'RequestInventoryCenterController@issue_without_po')->name('issue-without-po');
Route::post('save-issue-without-po', 'RequestInventoryCenterController@save_issue_without_po')->name('save-issue-without-po');


// sc challan 

Route::get('search-challan-sc', 'ApproveRequestInventoryController@search_challan_sc')->name('search-challan-sc');
Route::post('generate-challan-sc', 'ApproveRequestInventoryController@generate_challan_sc')->name('generate-challan-sc');

//manual challan view
Route::get('view-manual-Challan', 'ApproveRequestInventoryController@view_manual_Challan')->name('view-manual-Challan');
Route::post('get-center-detail', 'ApproveRequestInventoryController@get_center_detail')->name('get-center-detail');
Route::post('download-manual-Challan', 'ApproveRequestInventoryController@download_manual_Challan')->name('download-manual-Challan');


// manual challan
#Route::get('generate-manual-challan', 'ApproveRequestInventoryController@generate_manual_challan')->name('generate-manual-challan');
Route::match(['get', 'post'],'generate-manual-challan', 'ApproveRequestInventoryController@generate_manual_challan')->name('generate-manual-challan');

// asc stock management
Route::match(['get', 'post'],'asc-stock', 'StockController@asc_stock')->name('asc-stock');
Route::match(['get', 'post'],'part-asc-stock', 'StockController@part_asc_stock')->name('part-asc-stock');

Route::match(['get', 'post'],'part-defective', 'StockController@part_defective')->name('part-defective');
Route::match(['get', 'post'],'fresh-stock-download', 'StockController@fresh_stock_download')->name('fresh-stock-download');

// job book settlement
Route::match(['get', 'post'],'job-book-settlement', 'StockController@job_book_settlement')->name('job-book-settlement');
Route::match(['get', 'post'],'issue-job-book', 'StockController@issue_job_book')->name('issue-job-book');
Route::match(['get', 'post'],'get-state-by-region', 'StockController@get_state_by_region')->name('get-state-by-region');
Route::match(['get', 'post'],'get-asc-name-by-state', 'StockController@get_asc_name_by_state')->name('get-asc-name-by-state');

//srno get
Route::post('get-sr-no', 'SrnoController@get_srno_by_part_code')->name('get-sr-no');
Route::post('get-part-detail-using-srno', 'SrnoController@get_part_detail_using_srno')->name('get-part-detail-using-srno');
