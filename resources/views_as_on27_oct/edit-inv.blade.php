                ...
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <form id="spare_form" method="post" action="update-inv" >
                                <div class="form-row">
                                    <div class="col-md-4">
                                 ...
                                 <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="stock_qty" id="stock_qty" placeholder="Stock Quantity" type="number" value="<?php echo $data['stock_qty'];  ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>                                
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            <label for="exampleAddress" class="">Average Consumption <font color="red">*</font></label>
                                            <input name="avg_consmptn" id="avg_consmptn" placeholder="Consumption" type="number" onkeypress="return checkNumber(this.value,event)" value="<?php echo $data['avg_consmptn'];  ?>" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>                                                                
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            <label for="exampleAddress" class="">Average Balance <font color="red">*</font></label>
                                            <input name="bal_qty" id="bal_qty" onblur="get_mol(this.value)" placeholder="Balance" type="number" value="<?php echo $data['bal_qty'];  ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            <label for="exampleAddress" class="">Minimum Order Level (MOL) <font color="red">*</font></label>
                                            <input name="mol" id="mol" placeholder="MOL" type="number" onkeypress="return checkNumber(this.value,event)" value="<?php echo $data['mol'];  ?>" class="form-control" required="" readonly="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="add-inv" class="mt-2 btn btn-danger"   title="Cancel">Cancel</a>
                            </form>
