            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Invoice View</h5>
                        ...
                        <form method="get" action="{{route('close-case-view')}}" class="form-horizontal"  >
                                 ...
                                 <?php $srno = 1;
                                        foreach($DataArr as $record)
                                        {
                                            ...
                                            echo $srno++.'</td>';
                                                ...
                                                echo '<td>';
                                                if($record->inv_status=='0')
                                                {
                                                    echo '<a href="tax-invoice?TagId='.$record->TagId."&whereTag=$whereTag".'">Edit</a>';
                                                }
                                                else
                                                {
                                                    echo '<a href="tax-invoice?TagId='.$record->TagId."&whereTag=$whereTag".'">create</a>';
                                                }
                                                echo '</td>';
                                                ...
                                                if($record->inv_status=='0')
                                                {
                                                    echo '<a href="generate-TXInvoice?TagId='.$record->TagId."&whereTag=$whereTag".'">PDF</a>';
                                                }
