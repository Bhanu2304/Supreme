...
<div class="app-main"> 
    <div class="app-main__outer">
        ...
        <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
            <li class="nav-item">
                <a role="tab" class="nav-link <?php if((isset($tab1) && $tab1 == "tab1") || (!isset($tab1) && !isset($tab2))){echo "active"; }?>" id="tab-1" data-toggle="tab" href="#tab-content-1">
                    <span>View Dispatch</span>
                </a>
            </li>
            <li class="nav-item">
                <a role="tab" class="nav-link <?php if(isset($tab2) && $tab2 == "tab2"){echo "active"; }?>" id="tab-0" data-toggle="tab" href="#tab-content-0">
     ...
     <div class="tab-content">
         ...
         <div class="tab-pane tabs-animation fade <?php if(isset($tab2) && $tab2 == "tab2"){echo "show active"; }?> " id="tab-content-0" role="tabpanel">
                    ...
                    <div class="card-body">                                        
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Challan No.</label>
                                        ...
                                        <input type="text" name="challan_no2" id="challan_no2" class="form-control" value="<?php echo $challan_no;?>"  placeholder="Challan No.">
                                    </div>
                                </div>
      
                                <div class="col-md-2">
                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Job Number</label>
                                        <input type="text" name="job_no2" id="job_no2" class="form-control" value="<?php echo $job_no2;?>"  placeholder="Job Number">
                                    </div>
                                </div>
                        ...
                        <table border="1" style="font-size:13px;text-align:center;" id="table_id">
                            ...
                            <?php   $srno = 1;
                                    ...
                                    {
                                        echo '<tr id="tr'.$dispatch->approve_id.'">';
                                            echo '<td>'.$srno++.'</td>';
                                            echo '<td>'.date('d-m-Y', strtotime($dispatch->challan_date)).'</td>';
                                            echo '<td>'.$dispatch->challan_no.'</td>';
                                            echo '<td>'.$dispatch->brand_name.'</td>';
                                            echo '<td>'.$dispatch->job_no.'</td>';
                                            echo '<td>'.$dispatch->invoice_no.'</td>';
                                            echo '<td>'.$dispatch->net_total.'</td>';
                                            echo '<td>';?>
                                                <?php echo $dispatch->e_way_no;?>
                                            <?php echo '</td>';
                                            echo '<td>'.$dispatch->center_name.'</td>';
                                            echo '<td>';?>
                                                <input type="text" autocomplete="off" maxlength="20" id="doc_no<?php echo $dispatch->approve_id; ?>" name="doc_no<?php echo $dispatch->approve_id; ?>"  />
                                            <?php echo '</td>';
                                            echo '<td>';?>
                                                <input type="text" autocomplete="off" maxlength="20" id="veh_doc_no<?php echo $dispatch->approve_id; ?>" name="veh_doc_no<?php echo $dispatch->approve_id; ?>"  />
                                            <?php echo '</td>';
                                            echo '<td>';?>
                                            <input type="text" autocomplete="off" maxlength="20" id="transportation_charge<?php echo $dispatch->approve_id; ?>" name="transportation_charge<?php echo $dispatch->approve_id; ?>"  />
                                        <?php echo '</td>';
                                            echo '<td>';?>
                                                <input type="text" autocomplete="off" maxlength="20" id="dispatch_ref_no<?php echo $dispatch->approve_id; ?>" name="dispatch_ref_no<?php echo $dispatch->approve_id; ?>"  />
                                            <?php echo '</td>';
                                            
                                            echo '<td>';?>
                                            <input type="text" onkeypress="return checkNumber(this.value,event)" autocomplete="off" id="no_of_cases<?php echo $dispatch->approve_id; ?>" name="no_of_cases<?php echo $dispatch->approve_id; ?>"  />
                                            <?php echo '</td>';
                                            
                                            
                                            echo '<td>';?>
                                            <input autocomplete="off" type="text" id="remarks<?php echo $dispatch->approve_id; ?>" name="remarks<?php echo $dispatch->approve_id; ?>"  />
                                            <?php echo '</td>';
                                            echo '<td><a href="#" onclick="approve('."'{$dispatch->approve_id}'".')">Dispatch</a></td>';
                                        echo '</tr>';
                                    }
                            ?>
                            </tbody>
         ...
         <div class="tab-pane tabs-animation fade <?php if((isset($tab1) && $tab1 == "tab1") || (!isset($tab1) && !isset($tab2))){echo "show active"; }?>" id="tab-content-1" role="tabpanel">
             <div class="main-card mb-3 card">
