     ...
     <div class="tab-content">
         ...
         <div class="tab-pane tabs-animation fade <?php if((isset($tab1) && $tab1 == "tab1") || (!isset($tab1) && !isset($tab2))){echo "show active"; }?> " id="tab-content-0" role="tabpanel">
             <div class="main-card mb-3 card">
                    ...
                    <div class="card-body"><h5 class="card-title">View Outward Stock</h5>
                        <form method="get" action="{{route('outward-view-po-sc')}}" class="form-horizontal">
                            ...
                            <?php   
                                ...
                                foreach($po_job_arr as $po_job)
                                {
                                    ...
                                    echo '<tr>';
                                        ...
                                        echo '<td>';
                                        echo '<a href="outward-job-part-po?tag_id='.base64_encode($po_job->invoice_id).'">View</a> || <a href="#" onclick="cancel('."'{$po_job->invoice_id}'".')">Cancel</a>';
                                        echo '</td>';
                                    echo '</tr>';
                                }
         ...
         <div class="tab-pane tabs-animation fade <?php if(isset($tab2) && $tab2 == "tab2"){echo "show active"; }?>" id="tab-content-1" role="tabpanel">
            <div class="main-card mb-3 card">
                    ...
                    <div class="card-body"><h5 class="card-title">VIEW APPROVE Outward</h5>
                        <form method="get" action="{{route('outward-view-po-sc')}}" class="form-horizontal">
