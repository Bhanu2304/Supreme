        ...
        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                <form method="post" action="upd-req-inv-entry" >
                    <div class="card-body">                                        
                        <h5 class="card-title">Edit PO Request</h5> <h5 class="card-title">Date : <?php echo date('d-m-y',strtotime($req_det->req_date)); ?></h5> <h5 class="card-title">Sr No. : <?php echo $req_det->req_no; ?></h5>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        ...
                                        <select id="brand_id1" name="brand" class="form-control" onchange="get_product_detail('1',this.value)" required="">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        ...
                                        <select id="product_id1" name="product" onchange="get_model('1',this.value)" onchange="get_model('1',this.value)" class="form-control" required="">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        ...
                                        <select id="model_id1" name="model" onchange="get_partcode('',this.value)" onchange="get_part_name('1',this.value)" class="form-control" required="">
                        ...
                        <div id="part_arr">    
                            <?php foreach($data_part_arr as $part_det) { $random_no = $part_det->spare_id; $part_name =$part_det->part_name; $part_code =$part_det->part_no; ?>
                            ...
                            <div class="form-row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Color <font color="red">*</font></label>
                                            <input type="text" autocomplete="off"  name="SparePart[<?php echo $random_no;?>][color]" id="color<?php echo $random_no;?>" value="<?php echo $part_det->color; ?>"  class="form-control" required="" />
                                        </div>
                                    </div>
    
                                    <div class="col-md-2">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Current Stock Qty. <font color="red">*</font></label>
                                            <input type="text" autocomplete="off" name="SparePart[<?php echo $random_no;?>][current_qty]" id="current_qty<?php echo $random_no;?>" value="<?php echo $part_det->current_qty; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div>

                                    <div class="col-md-2">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Required Qty. <font color="red">*</font></label>
                                            <input type="text" autocomplete="off" name="SparePart[<?php echo $random_no;?>][req_qty]" id="req_qty<?php echo $random_no;?>" oninput="calculateTotal(<?php echo $random_no;?>)" value="<?php echo $part_det->req_qty; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div>

                                    <div class="col-md-2">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Previous Qty. <font color="red">*</font></label>
                                            <input type="text" autocomplete="off"  name="SparePart[<?php echo $random_no;?>][previous_qty]" id="previous_qty<?php echo $random_no;?>" oninput="calculateTotal(<?php echo $random_no;?>)" value="<?php echo $part_det->previous_qty; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div>

                                    <div class="col-md-1">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Total Qty. <font color="red">*</font></label>
                                            <input type="text" autocomplete="off"  name="SparePart[<?php echo $random_no;?>][total_qty]" id="total_qty<?php echo $random_no;?>" value="<?php echo $part_det->total_qty; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div>
                                    <!-- <div class="col-md-3">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Current Purchase Amount <font color="red">*</font></label>
                                            <input type="text" autocomplete="off" name="SparePart[<?php echo $random_no;?>][curr_amt]" id="curr_amt<?php echo $random_no;?>" value="<?php echo $part_det->curr_amt; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div> -->
                                    <div class="col-md-2">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Last Purchase Amount <font color="red">*</font></label>
                                            <input type="text" autocomplete="off" name="SparePart[<?php echo $random_no;?>][po_amt]" id="po_amt<?php echo $random_no;?>" value="<?php echo $part_det->po_amt; ?>" onkeypress="return checkNumber(this.value,event)" class="form-control" required="" />
                                        </div>
                                    </div>
                            </div>
                            <?php } ?>
                        ...
                        <div class="form-row">
                            <div class="col-md-2">
                                <div class="position-relative form-group">
                                    <a href="req-inv-entry"  class="mt-2 btn btn-danger">Back</a>
