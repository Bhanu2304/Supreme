...
function generate_challan(invoice_id)
{
    $('#scc').html("");
    $('#err').html("");
    $.post('generate-challan',{invoice_id:invoice_id}, function(resp){
...
<div class="app-main__outer">
   <div class="app-main__inner">
      <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav">
         ...
         <li class="nav-item">
            <a role="tab" onclick="reloadPage();" class="nav-link <?php if(isset($tab2) && $tab2 == "tab2"){echo "active"; }?>" id="tab-1" data-toggle="tab" href="#tab-content-1">
            <span>View</span>
            </a>
         </li>
      </ul>
               ...
               <div class="card-body">
                  ...
                  <form method="get" action="{{route('search-challan')}}" class="form-horizontal">
                     <div class="form-row">
                        ...
                        <div class="col-md-2">
                           <div class="position-relative form-group">
                              <label for="examplePassword11" class=""> Type of Part</label>
                              <select name="type_of_part" id="type_of_part" class="form-control">
                        ...
                        <div class="col-md-2">
                           <div class="position-relative form-group">
                              <label for="examplePassword11" class="">To</label>
                              <input class="form-control" type="text" id="to" name="to" value="<?php echo $to;?>" placeholder="To">
                           </div>
                        </div>
                        ...
                        <?php $srno = 1;
                           foreach($DataArr as $record)
                           {
                              ...
                              echo '<tr id="tr'.$record->invoice_id.'">';
                                 ...
                                 echo $srno++.'</td>';
                                 echo '<td>';
                                 #echo date('d-m-Y',strtotime($record->create_date));
                                 echo '</td>';
                                 echo '<td>';
                                 ...
                                 if($record->status == 0)
                                 {
                                    #echo '<a href="generate-Challan?approve_id='.$record->approve_id.'">Genrate Challan </a>';
                                    echo '<a href="#" onclick="generate_challan('."'".$record->approve_id."'".');">Genrate Challan </a>';
                           ...
                           foreach($DataArr2 as $record)
                           {
                              #print_r($record);
                               echo '<tr id="tr'.$record->invoice_id.'">';
                                   ...
                                   {
                                       #echo '<a href="generate-Challan?approve_id='.$record->approve_id.'">Genrate Challan </a>';
                                       echo '<a onclick="generate_challan('."'".$record->invoice_id."'".');" href="#">Genrate Challan</a>';
                                   }
                  ...
                  <table id="table2" class="table table-striped table-bordered" style="width:100%">
                     ...
                     <tbody>
                        <?php $srno = 1;
                           ...
                           foreach($DataArr_view as $record)
                           {
                              #print_r($record);die;
                              echo '<tr>';
                                 echo '<td>';
