				...
				<td align="center">
					<img src="{{ asset('assets/images/logo-in.png')}}">
                                ...
                                <td width="370" style="text-align: right;font-size:15px; font-family:Arial, Helvetica, sans-serif;">
                                    ...
                                    <font color="#87CEEB" size="20px;"><b>INVOICE <?php echo $record_arr->invoice_no; ?></b></font><br>
                                    <b>Date</b> <?php echo date('F d,Y',strtotime($record_arr->created_at)); ?><br>
                                    <b>Due Date</b> <?php echo date('F d,Y',strtotime($record_arr->created_at.' +10 day')); ?><br>
                                    <b>P. O. Number</b> <?php echo $record_arr->po_no; ?><br>
                                    <b>P.O.  Date</b> <?php echo date('F d,Y',strtotime($record_arr->po_date)); ?>
				</td>
			</tr>
			</table>
		</td>	
...
<table   cellpadding="2" cellspacing="0">
	...
	<table  height = "200" cellpadding="0" cellspacing="0" >
		...
		<?php
			...
			?>
				<tr>
                                    <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:center;background: #DCDCDC;"><?php echo "<br><b>".$i++."</b>"; ?></td>
                                <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:left;"><?php echo "<br><b>".$record->model_name.'</b>'; ?><br><?php echo $record->part_name.' '.$record->color; ?></td>
				<td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;background: #DCDCDC;"><?php echo "<br><b>".$record->hsn_code.'</b>'; ?></td>
				<td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;"><?php echo "<br><b>".$record->issued_qty."</b>"; ?></td>
                                <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;background: #DCDCDC;"><?php echo "<br><b>".$record->asc_amount."</b>"; ?><br>-Discount <?php echo $record->discount; ?>%  </td>
                                <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;"><?php echo "<br><b>".$record->gst_amount."</b>"; ?><br> <?php echo $record->gst; ?>%</td>
                                <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;background: #DCDCDC;"><br><b>0.00</b></td>
                                <td align="center" valign="top" id = "t09" <?php if(count($part_arr)>20) { echo 'style="font-size:8px;"'; } ?> style="text-align:right;"><?php echo "<br><b>".$record->grand_total."</b>"; ?></td>
				</tr>
			<?php endforeach; ?>
	...
	<tr>
            <td colspan="4" id="t08"><br>
                    Total <?php echo $record_arr->uc_total; ?>.<br>
