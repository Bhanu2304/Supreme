                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <select id="center_id" name="center_id" class="form-control">
                                                ...
                                                <option value="{{$region->center_id}}" <?php if($region->center_id==$data['center_id']) { echo 'selected'; }  ?>>{{$region->center_name}} - {{$region->state_name}} - {{$region->city}} - {{$region->pincode}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
