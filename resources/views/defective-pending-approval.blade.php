        ...
        <div class="tab-content">
         ...
         <div class="tab-pane tabs-animation fade <?php if($tab!=='1') { ?>show active <?php } ?>" id="tab-content-0" role="tabpanel">
             <div class="main-card mb-3 card"> 
                    ...
                    <div class="card-body"><h5 class="card-title">View Defective Parts Pending For Approval</h5>
                        <form method="get" action="{{route('defective-approval')}}" class="form-horizontal">
                    ...
                    <div class="card-body">     
                        ...
                        <h5 class="card-title">View Defective Parts Pending For Approval</h5>
                            ...
                            <?php   $srno = 1;
                                    foreach($req_arr as $req)
                                    {
                                        ...
                                        echo '<tr '.'id="tr'.$req->id.'">';
                                            ...
                                            echo '<td>';
                                            if($req->approve==0 && $req->reject==0)
                                            {
                                                echo '<a href="#" onclick="save_def_pending('.$req->dpart_id.',1);">Approve</a> ||';
                                                echo ' <a href="#"  onclick="save_def_pending('.$req->dpart_id.',2)">Cancel</a>'; 

                                            }else if($req->approve==1){
                                                echo "Approved";
                                            }else {
                                                echo "Cancelled";
                                            }
...
function save_def_pending(dispatch_id,status)
{
