...
function part_defective(tagId)
{
    ...
    $.post('part-defective',{tagId:tagId}, function(resp)
    {
        ...
        if(obj.resp_id==='1')
        {
            ...
            $('#td'+tagId).html("Marked Defective");
            //$('#tr'+tagId).remove();
        }
        else
        { 
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group"><label for="examplePassword11" class="">PO Sr No</label>
                                            <input type="text" name="po_sr_no" id="po_sr_no" class="form-control" placeholder="PO Sr No">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Sr No</label>
                                            <input type="text" name="sr_no" id="sr_no" class="form-control" placeholder="Sr No">
                                    </div>
                                </div>
