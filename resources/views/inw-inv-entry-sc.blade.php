    ...
    <div class="app-main__outer">
     ...
     <div class="tab-content">
        ...
        <div class="tab-pane tabs-animation fade <?php if((isset($tab1) && $tab1 == "tab1") || (!isset($tab1) && !isset($tab2))){echo "show active"; }?> " id="tab-content-0" role="tabpanel">
            <div class="main-card mb-3 card">
                ...
                <div class="card-body"><h5 class="card-title">INWARD Stock</h5>
                    <form method="get" action="{{route('inward-inv-entry-sc')}}" class="form-horizontal">
                        ...
                        <?php   $srno = 1;
                                foreach($req_arr as $req)
                                {
                                    echo '<tr>';
                                        ...
                                        {
                                            echo '<td>';
                                            echo '<a href="view-inw-inv-entry-sc?inw_id='.base64_encode($req->inward_id).'">View</a>';
                                            echo '</td>';
                                        }
                                        else
                                        {
                                            echo '<td>';
                                            echo '<a href="po-inward-inv-cancel-sc?inw_id='.base64_encode($req->req_id).'">Cancel</a> || <a href="po-inward-inv-entry-sc?req_id='.base64_encode($req->req_id).'">Inward</a>';
                                            echo '</td>';
                                        }
        ...
        <div class="tab-pane tabs-animation fade <?php if(isset($tab2) && $tab2 == "tab2"){echo "show active"; }?>" id="tab-content-1" role="tabpanel">
            <div class="main-card mb-3 card">
                <form method="get" action="{{route('inward-inv-entry-sc')}}">
                    <div class="card-body">                                        
                        ...
                        <?php   $srno = 1;
                                foreach($req_arr3 as $req)
                                {
                                    echo '<tr>';
                                        ...
                                        echo '<td>';
                                        if(!empty($req->inwsc_date))
                                        {
                                            echo date('d-m-Y', strtotime($req->inwsc_date));
                                        }
                                        echo '</td>';
                                        echo '<td>'.$req->supplier_name.'</td>';
                                        echo '<td>'.$req->brand_name.'</td>';
                                        ...
                                        echo '<td><a href="view-inw-inv-entry-sc?inw_id='.base64_encode($req->inwsc_id).'">View</a></td>';
                                        //echo '<td><a href="edit-inw-inv-entry?inw_id='.base64_encode($req->inw_id).'">Edit</a></td>';
                                        echo '<td>
                                        <a href="mrf-pdf?type=preview&inw_id='.base64_encode($req->inwsc_id).'">View Pdf || </a>
