    ...
    if (input.files && input.files[0]) {
        ...
        else
        {
            ...
            reader.onload = function (e) {
                $('#img_demo').attr('src', e.target.result).width(150).height(200);
...
//             var reader = new FileReader();
//             reader.onload = function (e) {
//                 $('#img_demo_cl').attr('src', e.target.result).width(150).height(200);
//                 //console.log(e.target.result);
//             };
                            ...
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <div class="tabForm">
                                        ...
                                        <div class="card-body">
                                            <button type="button" id="Clarion1" class="tabFormlinksP active" onclick="openProduct(event, 'Clarion','Dealer','Cl')" >Clarion</button>
                                            ...
                                            <div id="Clarion" class="tabFormcontentP" style="display:block;">
                                                ...
                                                <input form="save_tagging_cl" type="hidden" id="TagId" name="TagId" value="<?php echo $TagId;?>" />
                                                <div class="tabForm">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="position-relative form-group"><label for="examplePassword11" class="">Dealer Name<span style="color: #f00;">*</span></label>
                                                                <input type="text" form="save_tagging_cl" name="DealerName" placeholder="Dealer Name" id="DealerNameCL" class="form-control" required>
                                                            </div>
                                                        </div>
                                            ...
                                            <div id="Vehicle_Detail" class="tabFormcontentCL">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <select form="save_tagging_cl" name="product_category" id="product_category" class="form-control" onchange="get_product_cl('_cl',this.value)" required>
                                                            <option value="">Select</option>
                                                             <?php  foreach($cl_category_master as $cl_category)
                                                                    {
                                                                        #print_r($cl_category);
                                                                        echo '<option value="'.$cl_category->product_category_id.'">'.$cl_category->category_name.'</option>';
                                                                    }
                                                            ?>
                                                        </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Vehicle Model<span style="color: #f00;">*</span></label>
                                                            <input form="save_tagging_cl"  name="vehicle_variant" id="vehicle_model" placeholder="Vehicle Model" type="text" class="form-control" required>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="Complaint_Details" class="tabFormcontentCL">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="position-relative form-group">
                                                            <button type="button" style="float:right;" onclick="openTab3('Complaint_Details','UploadDocuments');" class="mt-2 btn btn-success" >Next</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
