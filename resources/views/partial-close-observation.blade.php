...
function validate_product_details()
{
    ...
    else if(document.getElementById('man_ser_no').value==='')
    {
        alert('Please Fill Merchant Serial No.');
        return false;
    }
    else if(document.getElementById('dealer_name').value==='')
    {
        alert('Please Fill Dealer Name');
        return false;
    }
    else if(document.getElementById('Bill_Purchase_Date').value==='')
    {
        alert('Please Select Bill Purchase Date.');
        return false;
    }
    ...
    else if(document.getElementById('invoice').value!=='' && document.getElementById('invoice_no').value==='')
    {
                                            ...
                                            <div class="form-row">
                                                    ...
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Estimated Charge.</label>
                                                        ...
                                                        <input name="estmt_charge" id="estmt_charge" placeholder="Estimated Charge" type="number" value="<?php echo $data['estmt_charge']; ?>"
                                                               class="form-control" onKeyPress="return checkNumber(this.value,event);" 
                                                                   <?php if($data['warranty_card']=='No' && $data['invoice']=='No'){} else { ?>  disabled="" <?php } ?>>    
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Warranty Status <span style="color: #f00;">*</span></label>
                                                        <select name="warranty_status" id="warranty_status" class="form-control" required="">
                                                            <option value="">Select</option>
                                                            <?php
                                                                foreach($warranty_master as $warren)
                                                                {
                                                                    ?>       <option value="<?php echo $warren; ?>"><?php echo $warren; ?></option>     
                                                        <?php   }
                                                            ?>
                                                        </select>
                                                    </div>
