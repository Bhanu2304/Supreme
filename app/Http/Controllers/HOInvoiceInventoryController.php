...
class HOInvoiceInventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(!empty($invoice_no))
        {   
            $whereTag .= " and invoice_no = '$invoice_no' ";
        }

        if(!empty($brand_id))
        {   
            $whereTag .= " and brand_id = '$brand_id' ";
        }
        ...
        #echo "SELECT * FROM outward_inventory_invoice where 1=1 $whereTag";die;
        $invoice_arr = DB::select("SELECT * FROM outward_inventory_invoice where 1=1 $whereTag");
    ...
    public function create_invoice(Request $request)
    {
        ...
        {    
            ...
            'gst','color','req_qty','issued_qty','asc_amount','customer_amount','discount','remarks');
                ...
                $record->invoice_no = $sr_arr['new_request_no'];
                $record->sr_no = $$sr_arr['sr_no'];
