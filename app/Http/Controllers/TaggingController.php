...
order BY field_name,sub_field_name";
        ...
        $cl_category_master = DB::select("SELECT product_category_id,category_name FROM product_category_master where category_status='1' and brand_id='4'");
     ...
     $url = $_SERVER['APP_URL'].'/tagging-master';
       ...
       return view('tagging-data1')
        ->with('TagId',$TagId)
               ...
               ->with('cl_category_master',$cl_category_master)
    ...
    public function save_tagging(Request $request)
    {
       // print_r($request->all()); exit;
        ...
        if($tagging_type=='clarion')
        {
            ...
            $taggingArr->vehicle_variant  =  $vehicle_variant ;
            $taggingArr->logs_taken  =  $logs_taken ;
            ...
            $Product_Detail = $product_det->product_category_id;
