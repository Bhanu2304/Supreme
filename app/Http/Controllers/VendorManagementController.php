...
class VendorManagementController extends Controller
{
    ...
    public function view_complaint(Request $request)
    {
        ...
        {
            $whereTag .= " and tm.warranty_type='$warranty_category'";
        }
...
WHERE 1=1 "; 
    ...
    public function vehicle_save_observation(Request $request)
    {
        ...
        $product_category = addslashes($request->input('product_category'));
        $Product = addslashes($request->input('Product'));
        $Model = addslashes($request->input('Model'));
        ...
        system_sw_version='$system_sw_version',product_category_id='$product_category', Product='$product_name', Model='$model_name', product_id='$Product', model_id='$Model',vehicle_variant='$vehicle_variant' where TagId ='$RTagId'");
