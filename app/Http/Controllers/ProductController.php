...
WHERE brand_name='$brand_name'");
    ...
    public function get_product_by_brand_id(Request $request)
    {
        ...
        // echo "SELECT pm.product_id,pm.product_name FROM product_master pm 
        // INNER JOIN brand_master bm ON pm.brand_id = bm.brand_id AND brand_status='1' AND product_status='1'
        // WHERE 1=1 $str";die;
...
WHERE 1=1   $str");
    ...
    public function get_cl_product_by_category_id(Request $request)
    {
        ...
        // INNER JOIN product_master pm ON mm.product_id = pm.product_id AND pm.product_status='1' AND mm.model_status='1'
        // WHERE 1=1   $str";
        $qry = "SELECT product_id,product_name FROM `product_master` WHERE 1=1   $str";
        $product_master = DB::select($qry);
        ...
        foreach($product_master as $model)
        {
            echo '<option value="';
                echo $model->product_id.'">';
                echo $model->product_name.'</option>';
        }
        exit;
    }
