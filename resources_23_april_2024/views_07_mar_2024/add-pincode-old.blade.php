                    ...
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <select name="state_id" id="state_id" data-placeholder="" class="form-control chzn-select chzn-rtl multiselect" tabindex="9" required="">
                                                <option value="">Select</option>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <label for="exampleEmail11" class="">District</label>
                                            <input class="form-control" type="text" id="District" name="District" data-original-title="District" data-placement="top" placeholder="District" required="">
                                        </div>    
                                </div>
                                <div class="col-md-6">
                                        <div class="position-relative form-group">
