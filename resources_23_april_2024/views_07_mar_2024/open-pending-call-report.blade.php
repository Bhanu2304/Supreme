            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">Open Pending Call Report</h5>
                            <form method="post" action="export-open-pending-call">
                                <div class="form-row">
                                    <div class="col-md-2">
...
{ 
    ...
    function get_view()
    {
       ...
       var uqry = 'brand_id='+brand_id+'&from_date='+from_date+'&to_date='+to_date+'&report_type=view';
       ajax('export-open-pending-call',uqry,'disp_records');
