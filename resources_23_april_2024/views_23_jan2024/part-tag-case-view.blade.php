 ...
 <div class="app-main__outer">
                    <div class="app-main__inner">
                         <div class="tab-content">
                            <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                                <div class="main-card mb-3 card">
                                    <form method="post" action="part-case-approval" enctype="multipart/form-data">
                                    <div class="card-body"><h5 class="card-title">Part Pending Case View</h5>
						...
						<div class="col-md-4">
						    ...
						    <input name="State" id="State" placeholder="State" type="text" value="<?php echo $data['State']; ?>" class="form-control"  readonly="">
                                                    </div>
                                                </div>
						<div class="col-md-4">
						...
						<div class="col-md-4">
						    ...
						    <input name="Serial_No" id="Serial_No" placeholder="Serial No" type="text" class="form-control" <?php echo $data['Serial_No'];?> readonly=""></div>
                                                </div>
						...
						<div class="col-md-4">
						    ...
						    <select name="warranty_status" id="warranty_status" class="form-control" readonly="" required="">
                                                        <option value="<?php echo $data['warranty_status'];?>"><?php echo $data['warranty_status'];?></option>
						...
						<div class="col-md-4">
						    ...
						    <input name="remark" id="remark" value="<?php echo $data['remark'];?>" placeholder="Remark" type="text" class="form-control" readonly="">
                                                    </div>
                                                </div>

<div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Device Image <span style="color: #f00;">*</span></label>
						    <input name="device_image" id="device_image"  placeholder="device_image" type="file" class="form-control" <?php if(empty($data['device_image'])) { echo 'required=""';} ?>>
                                                    <?php
						    ...
						    <input name="invoice_copy" id="invoice_copy" placeholder="Invoice Copy" type="file" class="form-control" <?php if(empty($data['invoice_copy'])) { echo 'required=""';} ?>>
                                                    <?php
						...
						<div class="col-md-4">
						    ...
						    <input name="product_serial_no" id="product_serial_no" placeholder="product_serial_no" type="file" class="form-control">
                                                    <?php
						...
						<div class="col-md-4">
						    ...
						    <input name="product_photo1" id="product_photo1" placeholder="product_photo1" type="file" class="form-control">	
                                                    <?php
						    ...
						    <input name="product_photo2" id="product_photo2" placeholder="Product photo 2" type="file" class="form-control">
                                                    <?php
                                                ...
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Call Status <span style="color: #f00;">*</span></label>
                                                ...
                                                <div  class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Part Name<span style="color: #f00;">*</span></label>
                                                        <input name="part_name" id="part_name" placeholder="Part Name" type="text" value="<?php echo $data['part_name'];?>" class="form-control" required="">
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Part Code<span style="color: #f00;">*</span></label>
                                                        <input name="part_code" id="part_code" placeholder="Part Code" type="text" value="<?php echo $data['part_code'];?>" class="form-control">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Docket No.</label>
                                                        <input name="docket_no" id="docket_no" value="" placeholder="Docket No." type="text" class="form-control" required="">
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Courier Details</label>
                                                        <input name="courier_det" id="courier_det" value="<?php echo $data['courier_det'];?>" placeholder="Courier Details" type="text" class="form-control" >
                                                    </div>
                                                </div>
                                                
                                                <div class="col-md-4">
                                                    <div class="position-relative form-group"><label for="examplePassword11" class="">Remark</label>
                                                        <input name="part_remark" id="part_remark" value="<?php echo $data['part_remark'];?>" placeholder="Remark" type="text" class="form-control" >
                                                    </div>
                                                </div>
...
<!--                                    <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        <label for="examplePassword11" class="">Approval</label>
                                        <select id="part_approve" name="part_approve" class="form-control" required=""> 
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="position-relative form-group">                              
                                            <input type="submit"  class="btn btn-success btn-grad" data-original-title="" title="" value="Submit" >
                                        </div> 
                                </div>
