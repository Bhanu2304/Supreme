            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Edit Coordinator</h5>
                            <form method="post" action="coord-update">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="coord_name" id="coord_name" placeholder="Display Name" type="text" value="<?php echo $data['coord_name']; ?>" class="form-control" required="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <select id="coord_status" name="coord_status" class="form-control" required="">
                                            <option value="1" <?php if($data['coord_status']=='1') { echo 'selected';} ?>>Active</option>
                                            <option value="0" <?php if($data['coord_status']=='0') { echo 'selected';} ?>>De-Active</option>
                                        </select>
                                    </div>
                                     </div>
                                 </div>
                                 <input type="hidden" id="se_id" name="coord_id" value="<?php echo $data['coord_id']; ?>" />
                                 <a href="add-coord" class="btn btn-danger btn-grad btnr1" data-original-title="" title="">Back</a>
