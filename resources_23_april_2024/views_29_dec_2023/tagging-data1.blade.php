                                ...
                                <div class="main-card mb-3 card">
                                    <div class="tabForm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title">Customer Details</h5>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="position-relative form-group">
                                                            <br/>
                                                            <button  type="button" onclick="openTab1('Customer_Details_cl', 'Product_Details_cl');" class="mt-2 btn btn-success">Next</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="Product_Details_cl" class="tabFormcontent">
                                                <div class="form-row">
                                                    <div class="col-md-4">
