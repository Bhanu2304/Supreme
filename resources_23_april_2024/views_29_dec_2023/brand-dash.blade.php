...
<div class="app-main__outer">
   <div class="app-main__inner">
      ...
      <div class="row">
        <form id="brand_search_form" method="get" action="dashboard" class="form-horizontal">
         ...
         <form id="search_form" method="get" action="dashboard" class="form-horizontal"  >
            ...
            <div class="form-row">
               ...
               <div class="col-md-3">
                  <div class="position-relative form-group">
                     <label for="examplePassword11" class="">Warranty Category </label>
               ...
               <div class="col-md-3">
                  <div class="position-relative form-group">
                     <label for="examplePassword11" class="">Service Type </label>
               ...
               <div class="col-md-3">
                  <div class="position-relative form-group">
                     <label for="examplePassword11" class="">Job Status </label>
