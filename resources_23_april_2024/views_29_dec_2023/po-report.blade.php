            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body">
                            <h5 class="card-title">PO REPORT</h5>
                            <form method="post" action="export-po-report">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="position-relative form-group">
                                            <label for="exampleAddress" class="">Service Center</label>
                                            <Select name="region" id="region" class="form-control">
                                                <option value="">Select</option>
                                                <?php   foreach($sc_master as $sc_arr)
                                                        {
                                                            $asc_name =  $sc_arr->center_name;
                                                            echo '<option value="'.$sc_arr->center_id.'">'.$asc_name.'</option>';
                                                        }
                                                ?>
                                                ...
                                                <?php   foreach($brand_master as $brand_arr)
                                                        {
                                                            ...
                                                            echo '<option value="'.$brand_arr->brand_id.'">'.$brand.'</option>';
                                                        }
                                                ?>
                                            </select>
                                        </div>
...
//       var mobno = document.getElementById("mobno").value;
       ...
       var uqry = 'from_date='+from_date+'&to_date='+to_date+'&center_id='+Region+'&brand_id='+brand+'&report_type=view';
       ajax('export-po-report',uqry,'disp_records');
