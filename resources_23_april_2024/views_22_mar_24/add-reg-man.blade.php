            ...
            <div class="tab-content">
                <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                    <div class="main-card mb-3 card">
                        <div class="card-body"><h5 class="card-title">Head Office Users</h5>
                            ...
                            <form id="man_form" method="post" action="save-reg-man" style="display:none;">
                               
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <label for="exampleEmail11" class="">Email <span style="color: #f00;">*</span></label>
                                            <input name="email" id="email" placeholder="Email" type="email" class="form-control" autocomplete="off" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <select id="user_type" name="user_type" class="form-control" >
                                                ...
                                                <option value="<?php echo $ut->user_type;?>"><?php echo $ut->user_type;?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <table id="table_id" class="table table-striped table-bordered" style="width:100%">
                              <thead>
                                 <tr>
                                    ...
                                    <th>Email</th>
                                    <th>Mobile</th>
                                    <th>Region Tacking Care</th>
                                    <th>States Taking Care</th>
                                    <th>Status</th>
                                    <th>Action</th>
                                 </tr>
                              </thead>
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td class="emailid">{{$Data->region}}</td>
                                    <td class="emailid">{{$Data->state}}</td>
                                    <td class="Status">@if($Data->man_status=='1') {{'Active'}} @else {{'De-Active'}} @endif</td>
                                    <td class="Officer"><a href="edit-reg-man?reg_man_id=<?php echo base64_encode($Data->reg_man_id); ?>" >Edit</a></td>
                                 </tr>
                                 @endforeach
