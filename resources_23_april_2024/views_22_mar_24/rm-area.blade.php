...
function get_district(state_id,div_id){
    ...
    var selectedValues = $("#state_id").val() || [];

    $.post('get-district-by-state-id',{state_id:selectedValues,all:1}, function(data){
                        ...
                        <div class="card-body">
                            ...
                            <h5><font color="red" id="err1">@if(Session::has('error')) {{ Session::get('error') }} @endif</font></h5>
                                    ...
                                    <div class="form-row" id="asm_disp" style="display:none">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <select style="width:100%;" name="state_id[]" id="state_id" multiple="multiple" onchange="get_district(this.value,'dist_id')">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
                                <div class="col-md-6"></div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePassword11" class="">District</label><br>

                                                <!-- <select name="dist_id" id="dist_id"  class="form-control">
                                                    <option value="">Select</option>
                                                </select> -->
                                                <select style="width:100%;" name="dist_id[]" id="dist_id" multiple="multiple">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                        </div>
