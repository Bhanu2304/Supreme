                                                    ...
                                                    <tr>
                                                        <td style="height:200px;width: 500px;" align="center">
                                                            ...
                                                            <div style="text-align:right;">
                                                                <button type="button" style="background:#ffa500;width: 200px;font-size:16px;margin-top: 10px;font-weight: bold;" onclick="save_shd_time()" >Apply</button>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="position-relative row form-check">
                                                                    <div class="col-sm-10 offset-sm-2">
                                                                        <button type="button" onclick="save_follow_up()" class="btn btn-secondary">Save</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="float-container" >
                                                        <div id="img_cntr" class="float-child"> 
                                                            <div class="float-container">
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-md-12">
                                                                        <div class="position-relative form-group"><label for="file_type" class="">Image Type</label>
                                                                ...
                                                                <div class="float-child" style="height:280px; float:right">
...
<!--                                                                                    <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['warranty_card_copy']; ?>" target="_blank" >Download Image</a>-->
                                                                            ...
                                                                            <div class="position-relative form-group">
                                                                                ...
                                                                                <button type="button" style="width:100%" onclick="download_img('wrrn')" class="btn btn-primary">Download</button>
                                                            ...
                                                            <div class="float-child" style="height:250px;" id="wrrn_img_disp">
                                                                <img id="wrrn_img" src="<?php echo url('../storage/app/supreme/'.$data['warranty_card_copy']); ?>" style="width:150px"/>
                                                                <button type="button"   class="btn btn-primary" name="submit" onclick="save_image('wrrn')" style="float:right;margin-right: 70px;">save</button>   
                                                            </div> 
...
<!--                                                                        <a  href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['purchase_copy']; ?>" target="_blank" >Download Image</a>-->
                                                                ...
                                                                <div class="position-relative form-group">
                                                                                ...
                                                                                <button type="button" style="width:100%" onclick="download_img('prcs')" class="btn btn-primary">Download</button>
                                                    ...
                                                    <div class="float-child" style="height:250px;" id="prcs_img_disp">
                                                        <img id="prcs_img" src="<?php echo url('../storage/app/supreme/'.$data['purchase_copy']); ?>" style="width:150px"/>
                                                        <button type="button"   name="submit" class="btn btn-primary" onclick="save_image('prcs')" style="float:right;margin-right: 70px;">save</button>
...
<!--                                                                        <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['model_no_copy']; ?>" target="_blank" >Download Image</a>-->
                                                                    ...
                                                                    <button type="button" style="width:100%" id="remove_mdl" name="remove_mdl" onclick="remove_img('mdl')" class="mt-2 btn btn-primary">Remove</button>
                                                                </div>
                                                                <div class="position-relative form-group">
                                                                                
                                                                                <button type="button" style="width:100%" onclick="download_img('mdl')" class="btn btn-primary">Download</button>
                                                    ...
                                                    <div class="float-child" style="height:250px;" id="mdl_img_disp">
                                                        <img id="mdl_img" src="<?php echo url('../storage/app/supreme/'.$data['model_no_copy']); ?>" style="width:150px"/>
                                                        <button type="button"   name="submit" class="btn btn-primary" onclick="save_image('mdl')" style="float:right;margin-right: 70px;">save</button>
                                                    </div> 
                                                </div>
                                                    </div>
...
<!--                                                                        <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['serial_no_copy']; ?>" target="_blank" >Download Image</a>-->
                                                                    ...
                                                                    <div class="position-relative form-group">
                                                                                ...
                                                                                <button type="button" style="width:100%" onclick="download_img('srl')" class="btn btn-primary">Download</button>
                                                            ...
                                                            <div class="float-child" style="height:250px;" id="srl_img_disp">
                                                                <img id="srl_img" src="<?php echo url('../storage/app/supreme/'.$data['serial_no_copy']); ?>" style="width:150px"/>
                                                               <button type="button"   name="submit" class="btn btn-primary" onclick="save_image('srl')" style="float:right;margin-right: 70px;">save</button>
                                                            </div> 
                                                        </div>
                                                    </div>
...
<!--                                                                        <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['symptom_photo1']; ?>" target="_blank" >Download Image</a>-->
                                                            ...
                                                            <div class="position-relative form-group">
                                                                  ...
                                                                  <button type="button" style="width:100%" onclick="download_img('smtm1')" class="btn btn-primary">Download</button>
                                                    ...
                                                    <div class="float-child" style="height:250px;" id="smtm1_img_disp">
                                                        <img id="smtm1_img" src="<?php echo url('../storage/app/supreme/'.$data['symptom_photo1']); ?>" style="width:150px"/>
                                                               <button type="button"   name="submit" class="btn btn-primary" onclick="save_image('smtm1')" style="float:right;margin-right: 70px;">save</button>
                                                    </div> 
                                                </div>
                                                    </div>
...
<!--                                                                        <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['symptom_photo2']; ?>" target="_blank" >Download Image</a>-->
                                                                ...
                                                                <div class="position-relative form-group">
                                                                   ...
                                                                   <button type="button" style="width:100%" onclick="download_img('smtm2')" class="btn btn-primary">Download</button>
                                                                </div>
                                                            </div>
                                                        </div>  
                                                    ...
                                                    <div class="float-child" style="height:280px;" id="smtm2_img_disp">
                                                        <img id="smtm2_img" src="<?php echo url('../storage/app/supreme/'.$data['symptom_photo2']); ?>" style="width:150px"/>
                                                        
                                                               <button type="button"  name="submit" class="btn btn-primary" onclick="save_image('smtm2')" style="float:right;margin-right: 70px;">save</button>
                                                    </div> 
                                                        </div>  
...
<!--                                                                        <a href="<?php echo "{$str_server}/storage/app/supreme/".$data['TagId']."/".$data['symptom_photo3']; ?>" target="_blank" >Download Image</a>-->
                                                            ...
                                                            <div class="position-relative form-group">
                                                                     ...
                                                                     <button type="button" style="width:100%" onclick="download_img('smtm3')" class="btn btn-primary">Download</button>
                                                    ...
                                                    <div class="float-child" style="height:280px;" id="smtm3_img_disp">
                                                        <img id="smtm3_img" src="<?php echo url('../storage/app/supreme/'.$data['symptom_photo3']); ?>" style="width:70%"/>
                                                        
                                                               <button type="button"  name="submit" class="btn btn-primary" onclick="save_image('smtm3')" style="float:right;margin-right: 70px;">save</button>
                                                    </div> 
                                                </div>
                                                    </div>
                                                ...
                                                <form method="post" name="request_to_npc" id="request_to_npc" action="request-to-npc">
                                                    ...
                                                    <table border="1" id="tbl_part" style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="5" align="right"><button id="npc_approve"  disabled="" type="button" class="mt-2 btn btn-primary" onclick="return npc_approve_save();" >Request to NPC for part price</button> </td>
                                                        </tr>
                                                        </tbody>
                                                    </table> 
                                                </div> 
