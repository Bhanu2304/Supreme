                        ...
                        <div class="card-body">
                            ...
                            <div id="Vehicle_Detail" class="tabFormcontentCL" style="display: none;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Phone Make</label>
                                        <input form="save_tagging_cl" name="phone_make" id="phone_make" value="<?php echo $data['phone_make']; ?>" placeholder="Phone Make" type="text" class="form-control" ></div>
                                    </div>

                                    <div class="col-md-4">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Phone Model</label>
                                        <input form="save_tagging_cl" name="phone_model" id="phone_model" value="<?php echo $data['phone_model']; ?>" placeholder="Phone Model" type="text" class="form-control" ></div>
                                    </div>
                                </div>
                                <div class="form-row">
