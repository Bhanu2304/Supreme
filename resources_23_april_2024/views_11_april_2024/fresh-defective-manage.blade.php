                    ...
                    <div class="main-card mb-3 card">
                        ...
                        <form method="get" action="{{route('fresh-stock')}}" class="form-horizontal">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        <label>Stock Inward From Date</label>
                                ...
                                <div class="col-md-2">
                                    <div class="position-relative form-group">
                                        <label>Stock Inward To Date</label>
                            ...
                            <table id="table1" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <?php   $srno = 1;
                                    ...
                                    {   
                                        ...
                                        echo '<td id="td'.$req->return_id.'">';
                                       
                                            echo '<button style="width:85px;" type="submit" class="trigger_popup_fricc" onclick="canbalize('."'".$req->return_id."'".')" class="btn btn-success">Canbalize</button>';
                                            echo '<button style="width:85px;" type="submit" class="trigger_popup_fricc" onclick="def_return('."'".$req->return_id."'".')" class="mt-2 btn btn-primary">Defective Return</button>';
                                            echo '<button style="width:85px;" type="submit" class="trigger_popup_fricc" onclick="scrap('."'".$req->return_id."'".')" class="mt-2 btn btn-warning">Scrap</button>';
