...
class LoginController extends Controller
{
    ...
    */
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        $html = "";
        //print_r($menu_relation); exit;
        //$un_keys = array_keys($main_menu); //unordered keys for numbering the menu
        ...
        //Session::put('MenuArr999', array('main_menu'=>$main_menu,'menu_relation'=>$menu_relation,'page'=>$page));
